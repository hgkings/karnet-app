...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/trendyol-kargo-ucreti-hesaplama`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.75 },
    { url: `${BASE_URL}/trendyol-kdv-hesaplama`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.75 },
    { url: `${BASE_URL}/trendyol-reklam-maliyeti-hesaplama`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.75 },
