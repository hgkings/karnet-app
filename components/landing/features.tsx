      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-auto">
          ...
          <motion.div
            ...
            className="lg:col-span-2 group relative rounded-2xl border border-border bg-card p-6 hover:border-primary/40 hover:shadow-lg transition-all duration-300 overflow-hidden"
          >
          ...
          <motion.div
            ...
            className="group relative rounded-2xl border border-border bg-card p-6 hover:border-red-500/30 hover:shadow-lg transition-all duration-300 overflow-hidden"
          >
          ...
          <motion.div
            ...
            className="group relative rounded-2xl border border-border bg-card p-6 hover:border-orange-500/30 hover:shadow-lg transition-all duration-300 overflow-hidden"
          >
          ...
          <motion.div
            ...
            className="group relative rounded-2xl border border-border bg-card p-6 hover:border-purple-500/30 hover:shadow-lg transition-all duration-300"
          >
          ...
          <motion.div
            ...
            className="group relative rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/10 via-card to-card p-6 hover:border-primary/40 hover:shadow-lg transition-all duration-300"
          >
          ...
          <motion.div
            ...
            className="lg:col-span-2 group relative rounded-2xl border border-border bg-card p-6 hover:border-emerald-500/30 hover:shadow-lg transition-all duration-300 overflow-hidden"
          >
