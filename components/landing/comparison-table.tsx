      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="overflow-x-auto rounded-2xl border border-border shadow-sm bg-card">
          <table className="w-full min-w-[560px]">
            ...
            <thead>
              <tr>
                <th className="text-left px-6 py-5 text-sm font-semibold text-muted-foreground bg-muted/30 w-1/2 rounded-tl-2xl">
                  Özellik
                </th>
                ...
                <th className="px-6 py-5 bg-primary/8 border-x border-primary/20 w-[18%] relative">
                  ...
                  <div className="flex flex-col items-center gap-1">
                    <span className="text-[10px] font-bold text-primary-foreground bg-primary px-2 py-0.5 rounded-full leading-none">
                      En İyi Seçim
                    </span>
                    <span className="text-sm font-bold text-primary">Kârnet</span>
                  </div>
                </th>
                <th className="px-6 py-5 bg-muted/30 text-sm font-semibold text-muted-foreground text-center w-[16%]">
                  Excel 📊
                </th>
                <th className="px-6 py-5 bg-muted/30 text-sm font-semibold text-muted-foreground text-center w-[16%] rounded-tr-2xl">
                  Rakip Araçlar
                </th>
              </tr>
            </thead>
